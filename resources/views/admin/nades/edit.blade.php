            ...
            <div class="col-12 col-md-6">
                <div class="row mt-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" type="text" name="description" id="description" value="{{$nade->description}}" rows="3">{!! $nade->description !!}</textarea>
                    </div>
                    ...
                    <div class="col-12">
                        <label for="position_image">Preview Image</label>
                        <input class="form-control image_upload" id="preview_image" type="file">
                        <img class="img-fluid my-4" src="{{$nade->preview_image}}" id="preview_image">
                        <input class="form-control image_upload" id="preview_image" type="hidden" name="preview_image" value="{{$nade->preview_image}}">
                    </div>
